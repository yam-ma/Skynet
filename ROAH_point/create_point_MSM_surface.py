...
def main():
    ...
    for i in range(3):
        for j in range(13):
            for k in range(32):
                ...
                # FT=16-24
                path = "/home/yamada-m/MSM_data/MKFQjg/400220115/0000911000220115/" + years[i] + "/" + months[j] + "/" + days[k] + "/" + fname
                # print("path=", path)
    ...
    df_2015.to_csv("df_2015_surface_ROAH2.csv", index=True)
    df_2016.to_csv("df_2016_surface_ROAH2.csv", index=True)
    df_2017.to_csv("df_2017_surface_ROAH2.csv", index=True)
